...
def test_worker_post():
    response = client.post("/worker/create_worker", json={"id": 1,"name": "itsoda","trade_point_id": 1})
    assert response.status_code == 201
    assert response.json == {"status": 201, "data": {"id": 1,"name": "itsoda","trade_point_id": 1}, "detail": "Worker create successfully"}
